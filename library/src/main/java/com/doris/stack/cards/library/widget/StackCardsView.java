package com.doris.stack.cards.library.widget;
...
import com.doris.stack.cards.library.R;
import com.doris.stack.cards.library.helper.ISwipeTouchHelper;
import com.doris.stack.cards.library.helper.SwipeTouchHelper;
...
public class StackCardsView extends FrameLayout {
    ...
    public void onCoverStatusChanged(boolean idle) {
        if (idle) {
    ...
    public void onCardDismissed(int direction) {
        if (mCardSwipedListeners != null) {
    ...
    public void onCoverScrolled(View scrollingView, float progress, int direction) {
        if (mCardSwipedListeners != null) {
            for (OnCardSwipedListener listener : mCardSwipedListeners) {
    ...
    public void updateChildrenProgress(float progress, View scrollingView) {
        final int cnt = getChildCount();
